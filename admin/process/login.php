<?php
    ...
    if(!$nombre==""&&!$clave==""){
        $verUser=ejecutarSQL::consultar("select * from personal where email='$nombre' and clavePersonal='$clave'");
        $verAdmin=ejecutarSQL::consultar("select * from administrador where email='$nombre' and claveAdmin='$clave'");
        if($radio=="Admin"){
